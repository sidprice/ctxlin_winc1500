...
typedef enum {
	M2M_SUCCESS = 0,
	M2M_WIFI_INVALID_CHIP_REV_ERROR =
		1, // Read incorrect WINC1500 revision.  Either invalid WINC1500 revision or SPI interface has an error.
	...
	M2M_WIFI_SCAN_IN_PROGRESS_ERROR =
		6, // Scan already in progress; see m2m_wifi_request_scan(), m2m_wifi_request_scan_passive()
	M2M_WIFI_SCAN_CHANNEL_ERROR =
		7, // Invalid channel parameter in m2m_wifi_request_scan(), m2m_wifi_request_scan_passive()
