...
// CONSTANTS
//==============================================================================
// The AF_INET is the address family used for IPv4 and is the only supported type in the WINC1500 driver.
#define AF_INET          2
#define SOCK_STREAM      1 // The IPv4 supported socket type for reliable connection-oriented stream connection (TCP)
#define SOCK_DGRAM       2 // The IPv4 supported socket type for an unreliable connectionless datagram connection (UDP)
...
//  Used with sendsock() to ensure that the buffer sent is within the allowed range.
...
#define SSL_NON_ECC_CIPHERS_AES_256                                                 \
	(SSL_CIPHER_RSA_WITH_AES_256_CBC_SHA | SSL_CIPHER_RSA_WITH_AES_256_CBC_SHA256 | \
		SSL_CIPHER_DHE_RSA_WITH_AES_256_128_CBC_SHA | SSL_CIPHER_DHE_RSA_WITH_AES_256_CBC_SHA256)
/*!<
    AES-256 Ciphers.
...
#define _htons(x) ((((uint16_t)(x) & 0xff00) >> 8) | (((uint16_t)(x) & 0x00ff) << 8))
#endif
